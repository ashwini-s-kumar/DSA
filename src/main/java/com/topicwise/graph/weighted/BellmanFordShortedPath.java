...
public class BellmanFordShortedPath {
    ...
    private static void bellManFord(BellmanFordShortedPath graph, int src){
    ...
    public static void main(String[] arr) {
        ...
        BellmanFordShortedPath graph = new BellmanFordShortedPath(v, e);
